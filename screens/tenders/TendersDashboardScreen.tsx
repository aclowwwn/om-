...
export const TendersDashboardScreen: React.FC = () => {
  ...
  if (loading) return <div className="p-8 text-center text-gray-500">Querying marketplace opportunities...</div>;

  return (
    <div className="space-y-8">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Tendering & Procurement</h1>
          <p className="text-sm text-gray-500">Strategic Growth & Contract Management</p>
        </div>
        <div className="flex items-center gap-2">
           <div className="relative">
             <Search size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400" />
             <input type="text" placeholder="Search opportunities..." className="pl-10 pr-4 py-2 border rounded-xl text-sm outline-none focus:ring-2 focus:ring-indigo-500" />
           </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {[
          { label: 'Active Contracts', value: '12', icon: Briefcase, color: 'text-indigo-600 bg-indigo-50' },
          { label: 'Open Opportunities', value: '42', icon: Target, color: 'text-emerald-600 bg-emerald-50' },
          { label: 'Active Bids', value: '3', icon: Gavel, color: 'text-amber-600 bg-amber-50' },
          { label: 'Awards (YTD)', value: '8', icon: Award, color: 'text-purple-600 bg-purple-50' }
        ].map((stat, i) => (
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-100 bg-gray-50">
              <h2 className="text-xs font-bold text-gray-900 uppercase tracking-widest">Available Tenders</h2>
            </div>
        ...
        <div className="space-y-6">
           <div className="bg-slate-900 rounded-3xl p-6 text-white shadow-xl relative overflow-hidden">
             <div className="relative z-10">
               <h3 className="text-xl font-bold mb-2 tracking-tight italic">ProcureWise Intelligence</h3>
